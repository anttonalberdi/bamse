...
#bamse.sh
python ${bamsedir}/bamse.py -i ${workdir}/inputfile.txt -d ${workdir} -f CTANGGGNNGCANCAG -r GACTACNNGGGTATCTAAT -a 440 -x /home/projects/ku-cbd/people/antalb/databases/silva_nr_v132_train_set.fa.gz -t 1
